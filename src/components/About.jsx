                ...
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    >
                        <div className="flex items-center gap-4 mb-6 sm:mb-8">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.5em] text-cyan-400">Engineering Archive</span>
                        </div>

                        <h2 className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tighter text-white mb-6 sm:mb-10 leading-[0.9]">
                            OUR<br />
                            <span className="text-transparent" style={{ WebkitTextStroke: '1px rgba(255,255,255,0.4)' }}>DNA</span>
                        </h2>

                        <div className="space-y-4 sm:space-y-6 text-blue-100/40 text-base sm:text-lg font-light leading-relaxed max-w-xl">
                            <p>
                            ...
                            <p className="border-l border-white/10 pl-6 sm:pl-8">
                        ...
                        >
                            <Link to="/about">
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    className="px-8 sm:px-10 py-4 sm:py-5 bg-white text-black font-black uppercase text-[9px] sm:text-[10px] tracking-[0.4em] rounded-xl sm:rounded-2xl flex items-center gap-4 shadow-2xl"
                                >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 relative mt-12 lg:mt-0">
                        {/* Background Glow */}
                        <div className="absolute inset-0 bg-cyan-500/10 blur-[80px] sm:blur-[100px] rounded-full pointer-events-none" />
                        ...
                        {values.map((value, index) => (
                            ...
                            >
                                <div className="bg-white/[0.02] backdrop-blur-3xl p-8 sm:p-10 rounded-[2rem] sm:rounded-[3rem] border border-white/5 transition-all duration-500 hover:bg-white/[0.05] hover:border-white/20 hover:-translate-y-2 h-auto sm:h-[280px] flex flex-col justify-between">
                                    ...
                                    <div>
                                        <h3 className="text-lg sm:text-xl font-black text-white uppercase tracking-tight mb-2 sm:mb-3">
                                            {value.title}
                                        </h3>
                                        <p className="text-[10px] sm:text-[11px] font-light text-blue-100/30 leading-relaxed uppercase tracking-wider group-hover:text-blue-100/50 transition-colors">
                                            {value.description}
                                        </p>
                                    </div>

                                    <div className="absolute top-6 sm:top-8 right-6 sm:right-8 text-[7px] sm:text-[8px] font-black tracking-widest text-white/10 uppercase">v.0{index + 1}</div>
                                </div>
                            </motion.div>
                        ))}
                    </div>
