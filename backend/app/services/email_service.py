...
async def send_application_received_email(to_email: str, job_title: str, company_name: str = "Caldim"):
    ...
    <html>
      <body style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
        ...
        <p>Thank you for applying for the <strong>{job_title}</strong> position at <strong>{company_name}</strong>. We have successfully received your materials via our Recruitment Intelligence System.</p>
        
        <p>Our team is currently reviewing your application to evaluate your fit for the role. Please note that your profile will undergo both AI-assisted screening and manual review. We appreciate your patience and will reach out if your background matches our current requirements.</p>
        
        <p>Thank you for your interest in joining {company_name}. We wish you the best of luck in your career journey.</p>
        
        <p>Best regards,<br>The Recruitment Team</p>
        
        <hr style="border: none; border-top: 1px solid #eee; margin-top: 20px;">
        <p style="font-size: 0.8em; color: #888; font-style: italic;">This is an AI-generated response.</p>
      </body>
    </html>
    """
    await send_email_async(to_email, subject, body)
